...
# ============================================
    ...
    st.markdown(
        ...
        "Агент должен был отвечать на вопросы по лекциям и тестировать знания.\n\n"
        "---\n\n"
        "**Шаг 2: Загрузка PDF на GitHub**\n\n"
        "Все PDF-лекции были собраны в папку `data/` и загружены на GitHub. "
        "Это позволило использовать их как источник знаний.\n\n"
        "---\n\n"
        "**Шаг 3: Создание базы знаний**\n\n"
        "Написан скрипт `make_db.py`, который:\n"
        "- Извлекал текст из PDF\n"
        "- Разбивал на фрагменты по 1000 символов\n"
        "- Создавал эмбеддинги через `SentenceTransformer`\n"
        "- Сохранял всё в Chroma DB\n\n"
        "---\n\n"
        "**Шаг 4: Создание основы программы**\n\n"
        "Написан основной файл `app.py` на Streamlit с:\n"
        "- Чат-интерфейсом\n"
        "- Поиском по базе знаний\n"
        "- Режимами обучения и тестирования\n\n"
        "---\n\n"
        "**Шаг 5: Подключение GigaChat (Сбер)**\n\n"
        "Для переформулировки ответов подключён GigaChat API. "
        "Использован бесплатный freemium-режим (365 млн токенов в год).\n\n"
        "---\n\n"
        "**Шаг 6: Развёртывание на Streamlit Cloud**\n\n"
        "Приложение задеплоено на `share.streamlit.io`. "
        "Теперь оно доступно по ссылке:\n"
        "[https://ai-mentor-course.streamlit.app/](https://ai-mentor-course.streamlit.app/)\n\n"
        "---\n\n"
        "**Шаг 7: Тестирование и доработка**\n\n"
        "Проведено тестирование всех режимов, исправлены ошибки, добавлены новые функции:\n"
        "- Ползунок температуры для GigaChat\n"
        "- Режим тестирования студентов\n"
